...
function drawSpeedometerColourArc(options) {
    ...
    drawSpeedometerPart(options, 1.0, "rgba(255, 242, 6, 1)", startOfGreen);
    drawSpeedometerPart(options, 0.9, "rgba(0, 255, 2, 0.83)", endOfGreen);
    drawSpeedometerPart(options, 0.9, "rgba(255, 0, 0, 1) ", endOfOrange);
...
function getbmivalue(){
    ...
    document.getElementById('bmi').innerHTML = "BMI Value: " + newbmivalue;
    }
    else{
        result.innerHTML = "";
        newbmivalue = "";
